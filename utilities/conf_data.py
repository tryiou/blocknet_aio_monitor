...
xlite_daemon_legacy_paths = config["xlite_daemon_legacy_paths"]
...
blockdx_selectedWallets_blocknet = config["blockdx_selectedWallets_blocknet"]  # noqa: N816 # config key
