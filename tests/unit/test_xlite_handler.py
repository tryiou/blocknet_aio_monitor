...
class TestXliteHandler(unittest.TestCase):
    ...
    def _setup_app_container(self):
        ...
        self.mock_container.xlite_release_url = (
    ...
    def _setup_conf_data(self):
        ...
        self.mock_conf_data.xlite_launch_options = {"Linux": [], "Windows": ["--in-process-gpu"], "Darwin": []}
    ...
    def test_parse_xlite_daemon_conf_file_exists_valid_json(self):
        ...
        mock_data = {"key": "value"}
        with (
            patch("os.path.exists", side_effect=lambda path: "settings" in str(path)),
    ...
    def test_check_xlite_daemon_confs_sequence(self):
        ...
        with (
            ...
            mock_rpc.assert_called_once_with(
                rpc_user="user",
                rpc_password="pass",  # noqa: S106 # test fixture
                rpc_port=12345,
            )
    ...
    def test_start_xlite_linux(self):
        ...
        self.mock_container.system = "Linux"
        with patch("os.path.exists", return_value=True), patch.object(self.handler, "start_process") as mock_start:
    ...
    def test_start_xlite_download_fallback(self):
        ...
        with (
            patch("utilities.bin_handlers.xlite_handler.os.path.exists") as mock_exists,
    ...
    def test_close_xlite_with_process(self):
        ...
        with (
            patch.object(self.handler, "graceful_terminate") as mock_graceful,
