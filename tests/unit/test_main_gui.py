...
class TestBlocknetAioGui(unittest.TestCase):
    ...
    def _create_app_instance(cls):
        ...
        with patch('blocknet_aio_monitor.BinaryManager', return_value=cls.mock_binary_manager), \
    ...
    def test_init_setup(self, mock_init_grid, mock_setup_tooltips, mock_setup_management_sections,
                        mock_check_processes, mock_setup_load_images):
    ...
    def test_init_grid(self):
        ...
        for manager in [self.mock_binary_manager, self.mock_blocknet_manager,
                        self.mock_blockdx_manager, self.mock_xlite_manager]:
