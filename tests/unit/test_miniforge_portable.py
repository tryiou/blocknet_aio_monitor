...
class TestPortablePythonInstaller:
    ...
    def test_init(self, target_dir, system, arch, expected_system, expected_arch):
        ...
        with (
            patch("utilities.miniforge_portable.platform.system", return_value=system),
            patch("utilities.miniforge_portable.platform.machine", return_value=arch),
        ):
    ...
    def test_get_installer_filename_unsupported_os(self, target_dir):
        ...
        with (
            patch("utilities.miniforge_portable.platform.system", return_value="FreeBSD"),
    ...
    def test_download_success(self, mock_get, target_dir, mock_download_response):
        ...
        with (
            patch("utilities.miniforge_portable.platform.system", return_value="Linux"),
            patch("utilities.miniforge_portable.platform.machine", return_value="x86_64"),
        ):
            installer = PortablePythonInstaller(target_dir)
    ...
    def test_install_windows(
        ...
        with (
            patch("utilities.miniforge_portable.platform.system", return_value="Windows"),
            patch("utilities.miniforge_portable.platform.machine", return_value="x86_64"),
        ):
            installer = PortablePythonInstaller(target_dir)
            mock_get.return_value = mock_download_response
    ...
    def test_install_subprocess_error(
        ...
        with (
            ...
            with patch("builtins.open", create=True):  # noqa: SIM117
