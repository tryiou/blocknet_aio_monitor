...
def mock_keyring():
    ...
    with patch('utilities.keyring_manager.KEYRING_AVAILABLE', True), \
...
class TestKeyringManager:
    ...
    class TestHappyPath:
        ...
        def test_store_key_with_keyring_success(self, manager, mock_keyring):
            ...
            mock_keyring.set_password.assert_called_once_with(
                "blocknet_aio", "encryption_key", TEST_KEY
            )
    ...
    class TestErrorHandling:
        ...
        @pytest.mark.parametrize("test_name, setup_func, method_to_patch, expect_key_none", [
...
class TestKeyringMigration:
    ...
    def test_migrate_from_old_format_success_with_keyring(self, temp_dir, manager, old_config, mock_keyring):
        ...
        assert key == TEST_SALT
        mock_keyring.set_password.assert_called_once_with(
            "blocknet_aio", "encryption_key", TEST_SALT
        )
