...
class XliteFrameManager:
    ...
    def update_xlite_process_status_checkbox(self):
        ...
        self.xlite_process_status_checkbox_state.set(self.parent.xlite_process_running)

        # xlite_process_status_checkbox_string_var
        var = widgets_strings.xlite_running_string if self.parent.xlite_process_running else widgets_strings.xlite_not_running_string
    ...
    def update_xlite_daemon_process_status(self):
        ...
        self.xlite_daemon_process_status_checkbox_state.set(self.parent.xlite_daemon_process_running)

        # xlite_daemon_process_status_checkbox_string_var
        var = widgets_strings.xlite_daemon_running_string if self.parent.xlite_daemon_process_running else widgets_strings.xlite_daemon_not_running_string
