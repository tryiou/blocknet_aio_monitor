...
class BlocknetCoreFrameManager:
    def __init__(self, parent, master_frame, title_frame):
        ...
        width = 343
        self.blocknet_data_path_entry_string_var = ctk.StringVar(value=self.parent.utility.data_folder)
    ...
    def update_blocknet_bootstrap_button(self):
        ...
        if enabled:
            utils.enable_button(self.blocknet_download_bootstrap_button, img=self.parent.parent.install_img)
        else:
            utils.disable_button(self.blocknet_download_bootstrap_button, img=self.parent.parent.install_greyed_img)
    ...
    def update_blocknet_process_status_checkbox(self):
        ...
        self.blocknet_process_status_checkbox_state.set(self.parent.blocknet_process_running)
    ...
    def update_blocknet_custom_path_button(self):
        ...
        if condition:
            utils.enable_button(self.blocknet_custom_path_button)
        else:
            utils.disable_button(self.blocknet_custom_path_button)
    ...
    def update_blocknet_rpc_connection_checkbox(self):
        ...
        self.blocknet_rpc_connection_checkbox_state.set(self.parent.utility.valid_rpc)
    ...
    def on_custom_path_set(self, custom_path):
        ...
        self.blocknet_data_path_entry_string_var.set(self.parent.utility.data_folder)
